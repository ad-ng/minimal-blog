...
export class UserController {
  ...
  @ApiOkResponse({
    ...
    example: {
      ...
      password:
        '$argon2id$v=19$m=65536,t=3,p=4$sPFsxRKS3y29kr71/6MBdw$ovk+NjJImgigsC849FNSENRAl+hp77ru/tH4Nnp1/I0',
      names: 'NGOGA Adolphe',
      phoneNumber: null,
      role: 'USER',
  ...
  @ApiOkResponse({
    example: {
      ...
      data: {
        email: 'adolphengoga@gmail.com',
        password:
          '$argon2id$v=19$m=65536,t=3,p=4$AwuKax0YkhjX9KeGN64HQg$5ZuIa2AICoXXFLcQ5K3XJqn8QhwF9YBeRZoIfcEX5HU',
        names: 'NGOGA Adolphe',
